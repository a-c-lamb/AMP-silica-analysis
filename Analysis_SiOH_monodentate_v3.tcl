...
set N1 [atomselect top "index 2992"]
set Si1 [atomselect top "index 1529"]
set N2 [atomselect top "index 2944"]
set Si2 [atomselect top "index 2252"]
set N3 [atomselect top "index 2968"]
set Si3 [atomselect top "index 90"]
set N4 [atomselect top "index 2920"]
set Si4 [atomselect top "index 808"]
