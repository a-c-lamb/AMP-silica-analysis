...
##TAG-amine/surface
## RDF_TAGetherO--N
set gr [measure gofr $TAGetherO $AllN delta .1 rmax 10 usepbc 1 selupdate yes first 0 last -1 step 1]
set output [open "RDF_TAGetherO--N.dat" w]
puts $output "r g(r) int(r) hist(r)"
set r [lindex $gr 0]
set grout [lindex $gr 1]
set grout2 [lindex $gr 2]
...
## RDF_TAGterminalC--N
set gr [measure gofr $TAGterminalC $AllN delta .1 rmax 10 usepbc 1 selupdate yes first 0 last -1 step 1]
set output [open "RDF_TAGterminalC--N.dat" w]
puts $output "r g(r) int(r) hist(r)"
set r [lindex $gr 0]
set grout [lindex $gr 1]
set grout2 [lindex $gr 2]
...
## RDF_TAGcarbonylC--N
set gr [measure gofr $TAGcarbonylC $AllN delta .1 rmax 10 usepbc 1 selupdate yes first 0 last -1 step 1]
set output [open "RDF_TAGcarbonylC--N.dat" w]
puts $output "r g(r) int(r) hist(r)"
set r [lindex $gr 0]
set grout [lindex $gr 1]
set grout2 [lindex $gr 2]
...
## RDF_SurfOH--TAGcarbonylC
set gr [measure gofr $SurfOH $TAGcarbonylC delta .1 rmax 10 usepbc 1 selupdate yes first 0 last -1 step 1]
set output [open "RDF_SurfOH--TAGcarbonylC.dat" w]
puts $output "r g(r) int(r) hist(r)"
set r [lindex $gr 0]
set grout [lindex $gr 1]
set grout2 [lindex $gr 2]
...
## RDF_SurfOH--TAGterminalC
set gr [measure gofr $SurfOH $TAGterminalC delta .1 rmax 10 usepbc 1 selupdate yes first 0 last -1 step 1]
set output [open "RDF_SurfOH--TAGterminalC.dat" w]
puts $output "r g(r) int(r) hist(r)"
set r [lindex $gr 0]
set grout [lindex $gr 1]
set grout2 [lindex $gr 2]
...
## RDF_BulkO--TAGcarbonylC
set gr [measure gofr $BulkO $TAGcarbonylC delta .1 rmax 10 usepbc 1 selupdate yes first 0 last -1 step 1]
set output [open "RDF_BulkO--TAGcarbonylC.dat" w]
puts $output "r g(r) int(r) hist(r)"
set r [lindex $gr 0]
set grout [lindex $gr 1]
set grout2 [lindex $gr 2]
...
## RDF_BulkO--TAGterminalC
set gr [measure gofr $BulkO $TAGterminalC delta .1 rmax 10 usepbc 1 selupdate yes first 0 last -1 step 1]
set output [open "RDF_BulkO--TAGterminalC.dat" w]
puts $output "r g(r) int(r) hist(r)"
set r [lindex $gr 0]
set grout [lindex $gr 1]
set grout2 [lindex $gr 2]
...
hbonds -sel1 $TAGetherO -sel2 $AllN -dist 3.5 -ang 25 -plot no -writefile yes -outfile hbonds_TAGetherO--N.dat -polar yes -DA both -type unique -detailout hbonds_TAGetherO--N_details.dat
